...
public class ServiceMainActivity1Tcp extends ScreenOnActivity {
    ...
    private class SenderHandler extends Handler{
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                ...
                Message lengthMessage = outPutLengthHandler.obtainMessage();
                lengthMessage.obj = msg1;
                outPutLengthHandler.sendMessage(lengthMessage);
...
//                        }).start();
    ...
    private void initSocketRunnable() {
        try {
            ...
            String ip = SpUtil.getIp(ServiceMainActivity1Tcp.this);
            Log.d(TAG, "ip " + ip);
            ...
            HandlerThread senderThread = new HandlerThread("senderThread");
            senderThread.start();
            mSenderHandler = new SenderHandler(senderThread.getLooper());
...
//                        }
                ...
                try {
                    if (bufferInfo.size != 0) {
                        ...
                        Message message = mSenderHandler.obtainMessage();
                        message.obj = b;
